...
import { AiOutlineComment,AiOutlineUser, AiOutlineCalendar } from "react-icons/ai";
...
function Home() {
  ...
  console.log(ourProducts.slice(0, 5));
  console.log(ourProducts.slice(6, 11));
                ...
                >
                  ...
                  <div className="latest-post-content">
                    ...
                    <ul className="latest-post-acticle mb-10">
                      ...
                      <li className="acticle-item mr-25">
                        <span className="acticle-icon"><AiOutlineUser/></span>
                        <span>By {item.author}</span>
                      </li>
                      <li className="acticle-item">
                        <span className="acticle-icon"><AiOutlineCalendar/></span>
                        <span>{item.day}</span>
                      </li>
                    </ul>
        ...
        <div className="container">
          <ul className="manufacture-list">
            {manufactureImg.map((item, index) => {
              return (
                <li className="manufacture-item" key={`manufactureImg-${index}`}>
